...
def plot(file_paths,title):
    ...
    for file_path in file_paths:
        ...
        #plt.scatter(range(len(values)), values, label=name, marker='o')
...
if __name__ == '__main__':    
    # plt everything 
    plot(['Project2_continous/Scores/predator0MADDPG.csv',
        'Project2_continous/Scores/predator1MADDPG.csv',
        'Project2_continous/Scores/prey0MADDPG.csv'
        ],'Training')


    plot(['Project2_continous/Scores/predator0MADDPG_test.csv',
        'Project2_continous/Scores/predator1MADDPG_test.csv',
        'Project2_continous/Scores/prey0MADDPG_test.csv'
        ],'Testing')